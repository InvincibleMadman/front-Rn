  ...
  return (
    <div className="rounded-md border border-border bg-card p-3">
      ...
      <div className="mb-3 grid gap-3 xl:grid-cols-[minmax(0,1fr)_15rem]">
        ...
        <div className="flex items-center gap-2 rounded-lg border border-amber-500/20 bg-amber-500/8 px-3 py-2 text-[12px] text-muted-foreground">
      ...
      <div className="mt-3 rounded-lg border border-border bg-background px-3 py-2.5 text-[12px] text-muted-foreground">

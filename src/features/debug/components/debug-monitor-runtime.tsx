  ...
  if (variant === "inspect") {
    return (
      ...
      <div className="mb-2 flex items-center justify-between gap-3 border-b border-border pb-2">
          <p className="text-[12px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">运行态检查</p>
          <p className="text-[11px] text-muted-foreground">寄存器 / 局部变量在右侧详情中展示</p>
        </div>
        <div className="rounded border border-dashed border-border bg-background px-3 py-5 text-[14px] text-muted-foreground">
          运行态检查细节已整合到右侧证据面板。
        </div>
      </div>
    );
  ...
  return (
    <div className="rounded-md border border-border bg-card p-3">
      <div className="mb-2 flex items-center justify-between gap-3 border-b border-border pb-2">
        ...
        <p className="text-[11px] text-muted-foreground">栈帧 / 焦点位置</p>
      </div>

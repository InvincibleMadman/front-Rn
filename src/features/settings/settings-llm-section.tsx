  ...
  return (
    <form className="space-y-5" onSubmit={submitConfig}>
      ...
      <div className="grid gap-4 xl:grid-cols-3">
        ...
        <SettingsInfoGroup title="模型设置" description="默认模型和当前摘要">
          <SettingsEditRow
            label="Model"
            description="默认用于离线分析与辅助构建的模型名"
        ...
        <SettingsInfoGroup title="密钥来源" description="尽可能地安全读取密钥配置">
          <SettingsEditRow
            label="API key"
            description="写入当前节点配置"
